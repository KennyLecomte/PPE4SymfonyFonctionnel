 ...
 */
class Budget extends \TobatBundle\Entity\Budget implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'TobatBundle\\Entity\\Budget' . "\0" . 'id', '' . "\0" . 'TobatBundle\\Entity\\Budget' . "\0" . 'min', '' . "\0" . 'TobatBundle\\Entity\\Budget' . "\0" . 'max'];
        }
